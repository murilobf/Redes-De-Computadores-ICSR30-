...
while True:
    ...
    while not fim_transferencia:
        ...
        try:
            ...
            print("Servidor demorou tempo demais pra responder, desconectando")
            break
        ...
        if(DESCARTAR and random_descartar > 95):
            ...
            num_segmento, checksum = int(num_segmento), int(checksum)
            ...
            if(checksum != auxChecksum):
                ...
                sock.sendto(f"ACK|{qtde_segmentos_recebidos}".encode(),(udp_ip,udp_port))
    ...
    while tentativas < MAX_TENTATIVAS:
        ...
        for segmento in lista_segmentos:
            ...
            segmentos_unicos[num_segmento] = segmento
